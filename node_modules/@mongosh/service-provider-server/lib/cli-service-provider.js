...
class CliServiceProvider extends service_provider_core_1.ServiceProviderCore {
    ...
    static getLibmongocryptBindings() {
        try {
    ...
    static getVersionInformation() {
        ...
        return {
            ...
            libmongocryptVersion: tryCall(() => { var _a; return (_a = this.getLibmongocryptBindings()) === null || _a === void 0 ? void 0 : _a.ClientEncryption.libmongocryptVersion; }),
    ...
    async getNewConnection(uri, options = {}) {
        ...
        const { client, state } = await (0, devtools_connect_1.connectMongoClient)(connectionString.toString(), clientOptions, this.bus, mongodb_1.MongoClient);
        clientOptions.parentState = state;
    ...
    async getConnectionInfo() {
        ...
        const extraConnectionInfo = (0, service_provider_core_1.getConnectInfo)((_b = (_a = this.uri) === null || _a === void 0 ? void 0 : _a.toString()) !== null && _b !== void 0 ? _b : '', version, buildInfo, cmdLineOptsOrServerError, atlasVersion, topology);
        return {
            buildInfo: buildInfo,
            topology: topology,
            extraInfo: {
    ...
    async resetConnectionOptions(options) {
        ...
        const { client, state } = await (0, devtools_connect_1.connectMongoClient)(this.uri.toString(), clientOptions, this.bus, mongodb_1.MongoClient);
        try {
            await this.mongoClient.close();
        }
        catch (_a) { }

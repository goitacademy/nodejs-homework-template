...
class SnippetManager {
    ...
    async prepareNpm() {
        ...
        interrupted.checkpoint();
        const npmMetadataResponse = await (0, node_fetch_1.default)(npmMetadataURL);
        ...
        const npmTarball = await (0, node_fetch_1.default)(npmTarballURL);
        if (!npmTarball.ok) {
        ...
        return this.repos = await ((_a = this.inflightFetchIndexPromise) !== null && _a !== void 0 ? _a : (this.inflightFetchIndexPromise = (async () => {
            ...
            if (!repoData || refreshMode === 'force-refresh') {
                ...
                repoData = await Promise.all(sourceURLs.map(async (url) => {
                    const repoRes = await (0, node_fetch_1.default)(url);
                    if (!repoRes.ok) {
                    ...
                    try {
                        ...
                        this.messageBus.emit('mongosh-snippets:fetch-index-error', { action: 'parse-fetched', url, error: err === null || err === void 0 ? void 0 : err.message });
                ...
                try {
                    ...
                    this.messageBus.emit('mongosh-snippets:fetch-index-error', { action: 'save', error: err === null || err === void 0 ? void 0 : err.message });
                }
            }
    ...
    async editPackageJSON(fn) {
        ...
        try {
            ...
            this.messageBus.emit('mongosh-snippets:package-json-edit-error', { error: err === null || err === void 0 ? void 0 : err.message });
            if (err.code !== 'ENOENT') {
                throw err;
            }
        }
    ...
    async execFile([cmd, ...args]) {
        ...
        interrupted.checkpoint();
        const proc = (0, cross_spawn_1.default)(cmd, args, {
            cwd: this.installdir,

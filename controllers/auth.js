...
const register = async (req, res) => {
  ...
  const verificationCode = nanoid(); // код для верифікації email
...
const verifyEmail = async(req, res)=> {
  ...
  await User.findByIdAndUpdate(user._id, {verify: true, verificationCode: ""}); // verify: true & verificationCode: "" !!!

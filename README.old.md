fork - rename - clone repository - create new branch - commit - push - pull request - change base repository - base master - compare home work 2 -adble to merge - create pull request - merge pull request - go to master - pull

...
const {validateBody, isValidId, isEmptyBody} = require('../../middlewares/index');
...
router.delete('/:contactId', isValidId, ctrl.deleteById);
 ...
 router.put('/:contactId', isEmptyBody, isValidId, validateBody(schemas.addSchema), ctrl.updateById);

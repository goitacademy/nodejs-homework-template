...
module.exports.createContact = (req, res, next) => validate(schemaCreateContact, req.body, next)

module.exports.updateContact = (req, res, next) => validate(schemaUpdateContact, req.body, next)

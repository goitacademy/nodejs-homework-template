...
const add = async (req, res) => {
  /// const defaultImage = gravatar.url('taras__1@gmail.com', { s: '250' }, true)
  // const defaultImage = gravatar.url(req.body.email, {s: "250"}, true);
  /// const newContact = { ...req.body, image: defaultImage }  // ...req.body - contact з фронтенда, avatarURL:- поле image з user.js(папка models)
